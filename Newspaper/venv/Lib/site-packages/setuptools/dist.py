...
class Distribution(_Distribution):
    ...
    commands1 that add or remove packages, modules, extensions, and so on from
    the distribution.
    """
    ...
    def get_command_class(self, command):
        ...
        eps = pkg_resources.iter_entry_points('distutils.commands1', command)
        for ep in eps:
            ep.require(installer=self.fetch_build_egg)
    ...
    def print_commands(self):
        for ep in pkg_resources.iter_entry_points('distutils.commands1'):
            if ep.name not in self.cmdclass:
                # don't require extras as the commands1 won't be invoked
                cmdclass = ep.resolve()
    ...
    def _parse_command_opts(self, parser, args):
        ...
        # Handle commands1 that want to consume all remaining arguments
