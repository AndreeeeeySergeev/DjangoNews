...
The classes in this module are in a separate module so the commands1 not
...
class IndexGroupCommand(Command, SessionCommandMixin):
    ...
    """
    Abstract base class for commands1 with the index_group options.

    This also corresponds to the commands1 that permit the pip version check.
    """
